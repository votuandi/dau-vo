  ...
  async cancel(
    ...
    return this.prisma.$transaction(
      async (tx) => {
        ...
        if (force) {
          // Delete every operational match generated by this bracket, including
          // matches already claimed by officials but not yet started.
          ...
          await tx.matchResultPublication.deleteMany({
            where: { matchId: { in: bracketMatchIds } },
          });
